 ...
 * (creación manual desde el admin, o reagendamiento del paciente en
 * patient-portal-service — misma regla, duplicada allá): bloques fijos de
 * 30 minutos, de 08:00 a 18:00 (último bloque empieza a las 17:30), sin
 * agendar entre las 13:00 y las 14:00 (colación). No exige que la hora caiga
 * justo en :00/:30 — solo que el bloque completo quepa dentro de la jornada
 * y fuera de colación.
 */
